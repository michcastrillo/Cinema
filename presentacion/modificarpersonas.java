...
public class modificarpersonas extends javax.swing.JFrame {
    ...
    public modificarpersonas() {
        ...
        this.setTitle("Modificador de usuarios");
        mostrarDatosObjeto();
        mostrarDatosCombo();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(cmbcedulas, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(28, 28, 28)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (op!=0) {
                desapersonas modi = new desapersonas();
                desaclientes holi = new desaclientes();
                String nombre = nombretxt.getText();
                String cedula = cmbcedulas.getSelectedItem().toString();
                String genero = SeleccionGenero();
                holi.ModificarClientes(cedula, nombre, genero);
                modi.ModificarColab(cedula,nombre,genero);
                mostrarDatosObjeto();        
        }else{
